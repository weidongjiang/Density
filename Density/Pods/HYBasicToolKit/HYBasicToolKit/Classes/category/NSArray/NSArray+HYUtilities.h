 ...
 *  数组中对象为字符串类型的工具方法
 */
@interface NSArray (HYStringExtensions)
...
@property (readonly, getter=hy_arrayBySortingStrings) NSArray *hySortedStrings;

/*!
 *  将数组中的字符串以空格连接组成新字符串返回,如@[@”a”, @”b”];  返回@”a b”.
 */
@property (readonly) NSString *hyStringValue;
@end

/*!
 *  数组集合间的操作，如合并，交，补集等工具方法。
 */
@interface NSArray (HYUtilityExtensions)
/*!
 ...
 *  @return 合并后的新数组
 */
- (NSArray *)hy_unionWithArray:(NSArray *)array;
 ...
 *  @return 返回包含公共元素的新数组
 */
- (NSArray *)hy_intersectionWithArray:(NSArray *)array;
 ...
 */
- (NSArray *)hy_intersectionWithSet:(NSSet *)set;
 ...
 *  对数组对象操作的相关工具方法。
 */
@interface NSMutableArray (HYUtilityExtensions)
/*!
...
@property (readonly, getter=hy_reverse) NSMutableArray *hy_reversed;
 ...
 */
@interface NSArray (HYExtendedArray)
/*!
 ...
 */
@interface NSMutableArray (HYStackAndQueueExtensions)
 ...
 *  判断当前数组是否为空
 */
@property(nonatomic,readonly,getter=hy_isEmpty) BOOL hy_empty;
