...
@implementation UIImage (HYImageEffects)
+ (UIImage *)hy_applyLightEffect
{
    UIColor *tintColor = [UIColor colorWithWhite:1.0 alpha:0.3];
    return [UIImage hy_applyBlurWithRadius:30 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)hy_applyExtraLightEffect
{
    ...
    return [UIImage hy_applyBlurWithRadius:20 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)hy_applyTintEffectWithColor:(UIColor *)tintColor
{
    ...
    return [UIImage hy_applyBlurWithRadius:10 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
