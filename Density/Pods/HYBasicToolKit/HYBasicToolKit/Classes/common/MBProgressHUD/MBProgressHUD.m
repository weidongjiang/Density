...
#define kCOLOR_HEX_ALPHA(rgbValue,a)   [UIColor colorWithRed:((float)((rgbValue & 0xFF0000) >> 16))/255.0 green:((float)((rgbValue & 0xFF00) >> 8))/255.0 blue:((float)(rgbValue & 0xFF))/255.0 alpha:a]
...
- (void)setupViews {
    ...
    bezelView.alpha = 0.f;
    bezelView.color = kCOLOR_HEX_ALPHA(0x000000, 0.3);
...
#pragma mark - Labels
//detailsLabelText
//labelColor labelFont labelText
