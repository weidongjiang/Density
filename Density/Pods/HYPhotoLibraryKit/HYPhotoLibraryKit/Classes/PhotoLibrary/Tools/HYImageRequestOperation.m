//
//  HYImageRequestOperation.m
//  AIPhotos
//
//  Created by Json on 2021/4/13.
//

#import "HYImageRequestOperation.h"
#import "HYPhotoTools.h"

@implementation HYImageRequestOperation
...
- (void)start {
    self.executing = YES;
    [HYPhotoTools getOriginalPhotoWithAsset:self.asset progressHandler:^(double progress, NSError *error, BOOL *stop, NSDictionary *info) {
